...
import {
  ...
  Maximize2, Minimize2, Signal, User
} from 'lucide-react';
...
const VideoCallModal = ({
  roomName, targetUserId, callType, isInitiator, participantName, onClose
}: VideoCallModalProps) => {
  ...
  // Auto-close when call ends or fails
  useEffect(() => {
    if (callState === 'ended' || callState === 'failed') onClose();
  }, [callState, onClose]);
